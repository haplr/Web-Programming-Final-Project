...
## Project Description
Our web application is a movie recommendation and library platform designed to help users discover, organize, and track movies and TV shows. At its core, the application allows users to browse a large collection of movies and shows, explore actor and film information, and maintain a personalized watch list to keep track of what they’re currently watching, planning to watch, or have completed. 
...
* Actor List Page: Shows the user a list of actors.
